...
\begin{frame}{Provisioning Profile}
\begin{enumerate}
...
\item Provisoining profiles provide the only means by which an iOS device will accept to run code that has not been signed by Apple.
\end{enumerate}
\end{frame}
